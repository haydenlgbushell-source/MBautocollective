...
const WHATSAPP_NUMBER = '61482710044';
...
export default function ChatBubble() {
  ...
  return (
    <div className="fixed bottom-8 right-8 z-[200] flex flex-col items-center gap-3" style={{ fontFamily: 'var(--fb)' }}>
      {/* Panel */}
      {open && (
        <div className="absolute bottom-[148px] right-0 w-[280px] bg-bg-3 border border-border shadow-[0_20px_60px_rgba(0,0,0,0.6)]">
